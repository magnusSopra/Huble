...
export class UI {
  constructor(app, actions) {
    ...
    app.innerHTML = `
      ...
      <section id="combat-hud" hidden><div class="combat-top"><span id="review-label" class="micro">MANDATORY PERFORMANCE REVIEW</span><h2 id="boss-name"></h2><div class="boss-health"><i id="boss-bar"></i></div><span id="boss-hp"></span><div id="boss-phase" class="boss-phase"></div></div><div id="attack-callout"></div><div id="hazard-warning" hidden></div><div class="crosshair">+</div><div class="combat-bottom"><div class="combat-player">${icon('heart')} <strong id="combat-hp">100</strong><span>HEALTH</span></div><div class="combat-controls"><span><kbd>WASD</kbd> Move &nbsp; <kbd>MOUSE</kbd> Look &nbsp; <kbd>CLICK</kbd> Punch</span><span><kbd>SPACE / RIGHT CLICK</kbd> Dodge &nbsp; <kbd>Q / R</kbd> Turn &nbsp; <kbd>F</kbd> Punch</span></div><div class="dodge-meter"><span id="dodge-label">DODGE READY</span><div><i id="dodge-bar"></i></div></div></div><div id="lock-hint">Click the arena to look with your mouse. Q / R also turn.</div></section>
